  ...
  async function handleFile(file: File) {
    ...
    try {
      ...
      const idx = {
        ...
        previousPlotNo: colIndex(IMPORT_TEMPLATE_HEADERS[1]),
        clientCode: colIndex(IMPORT_TEMPLATE_HEADERS[2]),
        factoryCode: colIndex(IMPORT_TEMPLATE_HEADERS[3]),
        divisionCode: colIndex(IMPORT_TEMPLATE_HEADERS[4]),
        sectionCode: colIndex(IMPORT_TEMPLATE_HEADERS[5]),
        villageCode: colIndex(IMPORT_TEMPLATE_HEADERS[6]),
        farmerCode: colIndex(IMPORT_TEMPLATE_HEADERS[7]),
        farmerName: colIndex(IMPORT_TEMPLATE_HEADERS[8]),
        farmerPhone: colIndex(IMPORT_TEMPLATE_HEADERS[9]),
        plantingDate: colIndex(IMPORT_TEMPLATE_HEADERS[10]),
        plantingSeason: colIndex(IMPORT_TEMPLATE_HEADERS[11]),
        crushingSeason: colIndex(IMPORT_TEMPLATE_HEADERS[12]),
        plotType: colIndex(IMPORT_TEMPLATE_HEADERS[13]),
        cropType: colIndex(IMPORT_TEMPLATE_HEADERS[14]),
        variety: colIndex(IMPORT_TEMPLATE_HEADERS[15]),
        irrigationType: colIndex(IMPORT_TEMPLATE_HEADERS[16]),
        waterSource: colIndex(IMPORT_TEMPLATE_HEADERS[17]),
        soilType: colIndex(IMPORT_TEMPLATE_HEADERS[18]),
        seedType: colIndex(IMPORT_TEMPLATE_HEADERS[19]),
        spacingFeet: colIndex(IMPORT_TEMPLATE_HEADERS[20]),
        areaAcres: colIndex(IMPORT_TEMPLATE_HEADERS[21]),
      }
      ...
      const inputRows: ImportRowInput[] = dataRows.map((r) => ({
        ...
        previousPlotNo: cellToString(r[idx.previousPlotNo]),
